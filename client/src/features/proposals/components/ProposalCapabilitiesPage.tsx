...
export function ProposalCapabilitiesPage({
  ...
  return (
    <div className="proposal-page min-h-[11in] p-16 bg-white relative">
      {/* Section Title */}
      <h1 className="text-3xl font-bold text-[#123da7] mb-4">
        Scan2Plan Capabilities
      </h1>

      {/* Target Audience */}
      <p className="text-[#123da7] font-semibold mb-8">
      ...
      <div className="grid grid-cols-2 gap-x-12 gap-y-6">
        ...
        <div className="space-y-6">
          {/* Scan-to-BIM */}
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Scan-to-BIM</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              ...
              <ul className="ml-6 space-y-1">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5">•</span>
                  <span><span className="text-[#123da7] underline">LoD 200</span> (Approximate Geometry)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5">•</span>
                  <span><span className="text-[#123da7] underline">LoD 300</span> (Accurate Geometry)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5">•</span>
                  <span><span className="text-[#123da7] underline">LoD 350</span> (Precise Geometry)</span>
                </li>
              </ul>
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">BIM to CAD Conversion</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
        ...
        <div className="space-y-6">
          {/* MEPF Modeling */}
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">MEPF Modeling</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
          ...
          {/* Landscape */}
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Landscape</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
          ...
          {/* Matterport 3D Tour */}
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Matterport 3D Tour</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
          ...
          {/* Paper to BIM or CAD */}
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Paper to BIM or CAD</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Model Only / Point Cloud Only</h2>
            <ul className="text-sm text-gray-700 space-y-1.5 ml-4">
              <li className="flex items-start gap-2">
                <span className="mt-1.5">•</span>
      ...
      <div className="mt-8">
        <p className="text-sm text-gray-700">
          We support: <span className="font-semibold text-[#123da7]">Revit, AutoCAD, Sketchup, Rhino, Vectorworks, Solidworks, Chief Architect, ArchiCAD, Civil 3D</span>, and others....
        </p>
      </div>

...
export function ProposalCoverPage({
  ...
  return (
    <div className="proposal-page cover-page flex flex-col justify-between min-h-[11in] p-16 bg-white relative">
      ...
      <div className="text-center space-y-8 flex-1 flex flex-col justify-center text-[#49494b]">
        <h1 className="text-5xl font-bold tracking-wider text-[#49494b]">- PROPOSAL -</h1>
        ...
        <div className="space-y-4">
          <EditableText
            ...
            onBlur={onBlur}
            as="h2"
            className="text-2xl font-semibold text-[#49494b]"
          ...
          <EditableText
            ...
            onBlur={onBlur}
            as="h2"
            className="text-xl font-bold text-[#49494b]"
          ...
          {data.areaScopeLines && data.areaScopeLines.length > 1 ? (
            <div className="space-y-1">
              {data.areaScopeLines.map((line, index) => (
                <EditableText
                  ...
                  onBlur={onBlur}
                  className="text-base font-semibold text-[#49494b]"
            ...
            <EditableText
              ...
              onBlur={onBlur}
              className="text-lg font-semibold text-[#49494b]"
      ...
      <div className="space-y-6">
        <div className="text-sm leading-relaxed text-[#49494b]">
          <p>
            ...
            <EditableText
              ...
              onBlur={onBlur}
              as="span"
              className="font-bold text-[#49494b]"
        ...
        {/* Page Footer */}
        <div className="border-t border-[#d1d5db] pt-3 text-center text-xs text-[#616161]">
